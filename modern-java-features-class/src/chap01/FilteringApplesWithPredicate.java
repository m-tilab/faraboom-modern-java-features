...
public class FilteringApplesWithPredicate {
    ...
    public static void main(String... args) {
        ...
        List<Orange> orangeInventory = Arrays.asList(
                new Orange(80, Color.GREEN),
                new Orange(155, Color.GREEN),
                new Orange(120, Color.RED));

        List<Orange> redOranges = filter(orangeInventory, (Orange o) -> o.getColor().equals(Color.RED));
        System.out.println(redOranges);
